...
<div class="max-w-5xl">
    ...
    <div class="space-y-5">
        ...
        <div id="inventory-fields" class="{{ old('inventory_enabled') ? '' : 'hidden' }}">
            <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                <div class="app-form-group">
                    ...
                    <select id="inventory_mode" name="inventory_mode" class="app-input">
                        ...
                        <option value="manual" {{ old('inventory_mode') === 'manual' ? 'selected' : '' }}>Manual</option>
                        <option value="agent" {{ old('inventory_mode') === 'agent' ? 'selected' : '' }}>Agent</option>
                        <option value="hybrid" {{ old('inventory_mode') === 'hybrid' ? 'selected' : '' }}>Hybrid</option>
                    </select>
                </div>
                ...
                <div class="app-form-group">
                    ...
                    <input
                        ...
                        class="app-input"
                        value="{{ old('inventory_partner_key') }}"
